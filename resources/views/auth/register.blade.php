            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Staff Code') }}</label>

                            <div class="col-md-6">
                                <input id="staff_code" type="text" class="form-control{{ $errors->has('staff_code') ? ' is-invalid' : '' }}" name="staff_code" value="{{ old('staff_code') }}" required>
